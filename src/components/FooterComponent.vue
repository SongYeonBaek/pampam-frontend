  ...
  <div class="footer">
    <div class="footer-left">
      ...
      <div class="footer-left-middle">
        <div class="footer-left-middle-1">평일: 전체 문의 상담</div>
        <div class="footer-left-middle-2">토요일, 공휴일: 오늘의집 직접배송, 이사/시공/제품설치 문의 상담</div>
        <div class="footer-left-middle-3">일요일: 휴무</div>
      </div>
      <div class="footer-left-bottom">
        <button class="footer-left-bottom-counseling-btn">카톡 상담(평일 09:00~18:00)</button>
        <a href="#" class="footer-left-bottom-counseling-btn">이메일 문의</a>
      </div>
    </div>
    ...
    <div class="footer-right">
      <div class="footer-right-1">
        <div class="footer-right-1-1">
          ...
          <div class="footer-right-1-1-element">
            <span class="footer-right-1-1-element-infomation"></span>
            <address class="css-ya1ij">서울시 동작구 신대방동 SfC빌딩 4층 2기</address>
          </div>
          <div class="footer-right-1-1-element">
            <span class="footer-right-1-1-element-infomation"></span>
